...
class condGANTrainer(object):
    ...
    def train(self):
        ...
        for epoch in range(start_epoch, self.max_epoch):
            start_t = time.time()
            print("Hi we are in epoch",epoch)
            for step, data in enumerate(self.data_loader, 0):
                ...
                if count % 100 == 0:
                    ...
                    print('Summary: D_loss = ',summary_D,' , G_loss = ',summary_G,' , KL_loss = ',summary_KL,' , count = %d '%(count))
